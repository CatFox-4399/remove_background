...
$translations = [
    ...
    'en' => [
        ...
        'cutout_mode_title' => 'Processing Mode',
        'mode_remove_bg' => 'Remove Background',
        'mode_remove_bg_badge' => 'Subject Kept',
        'mode_remove_bg_desc' => 'Isolates the foreground subject and makes the background transparent.',
        'mode_remove_inside' => 'Remove Inside (Invert)',
        'mode_remove_inside_badge' => 'Background Kept',
        'mode_remove_inside_desc' => 'Keeps the background and makes the inside subject transparent (reverse cutout).',
        'btn_remove_bg' => 'Remove Background',
        'btn_remove_inside' => 'Remove Inside (Reverse)',
        ...
        'inside_removed' => 'Inside Removed (Reverse Cutout)',
        'png_ready' => 'Transparent PNG Ready',
        'inside_png_ready' => 'Hollow Cutout PNG Ready',
        'original_img' => 'Original Image',
        'result_img' => 'Cutout Result',
        'result_mode_bg' => 'Background Removed',
        'result_mode_inside' => 'Inside Removed (Reverse)',
        'upload_another' => 'Upload Another',
        'download_png' => 'Download PNG',
        'download_inside_png' => 'Download Hollow PNG',
        'btn_edit_original' => 'Edit Photo (Skip AI)',
        'btn_edit_result' => 'Edit Cutout',
        'btn_invert_cutout' => 'Invert Cutout (Inside ⇄ Outside)',
        'invert_cutout_hint' => 'Toggle between keeping the subject or keeping the background.',
        ...
        'free_chop_interactive_title' => 'Interactive Free Chop',
        'free_chop_interactive_desc' => 'Drag the 8 handles on canvas or drag a box directly to freely chop picture borders.',
        'free_chop_reset' => 'Reset All Borders',
        'free_chop_square' => 'Square (1:1)',
        'free_chop_fit' => 'Fit Full',
        'free_chop_hint' => '💡 Tip: Drag corner or edge handles on canvas to chop borders. Drag the center to reposition.',
        'crop_top' => 'Top Cut',
        ...
        'filter_noir' => 'Noir Drama',
        'filter_golden' => 'Golden Hour',
        'filter_cinema' => 'Teal & Orange',
        'filter_pastel' => 'Pastel Dream',
        'filter_retro' => 'Retro 90s',
        'filter_emerald' => 'Emerald Forest',
        'filter_lilac' => 'Lilac Glow',
        'filter_invert' => 'Negative / Invert',
        'filter_popart' => 'Pop Art',
        'filter_nordic' => 'Nordic Frost',
        'filter_vignette' => 'Vignette Preset',
        'hue_rotate' => 'Color Hue Rotation',
        'vignette' => 'Vignette Edge Shading',
        'vignette_color' => 'Vignette Color',
        'vignette_panel_desc' => 'Add dark or colored radial shading around photo edges and corners for cinematic focus.',
        ...
        'pic_opacity_title' => 'Picture Transparency / Opacity',
        'pic_opacity_solid' => '100% Solid',
        'pic_opacity_75' => '75%',
        'pic_opacity_semi' => '50% Semi',
        'pic_opacity_faint' => '25% Faint',

        // Drop Shadow
        'shadow_title' => 'Drop Shadow & 3D Depth',
        'shadow_preset_soft' => 'Soft Drop',
        'shadow_preset_3d' => '3D Depth',
        'shadow_preset_float' => 'Float',
        'shadow_preset_halo' => 'Neon Halo',
        'shadow_preset_ground' => 'Ground',
        'shadow_color' => 'Shadow Color',
        'shadow_blur' => 'Shadow Softness (Blur)',
        'shadow_offset_x' => 'Horizontal Distance (X)',
        'shadow_offset_y' => 'Vertical Distance (Y)',
        'shadow_opacity' => 'Shadow Opacity / Intensity',

        // Free Cut & Stroke Style
        'shape_freecut' => 'Free Cut (Lasso)',
        'freecut_toolbar_title' => 'Interactive Free Cutout Tool',
        'freecut_mode_lasso' => 'Freehand Lasso',
        'freecut_mode_polygon' => 'Polygon Points',
        'freecut_points_count' => 'Points',
        'freecut_finish' => 'Finish Cut',
        'freecut_undo' => 'Undo Point',
        'freecut_reset' => 'Clear Path',
        'freecut_hint_lasso' => '💡 Tip: Click and drag on the photo to draw a freehand cutout loop!',
        'freecut_hint_polygon' => '💡 Tip: Click points around the subject to trace, then click Finish Cut!',
        'shape_stroke_title' => 'Sticker Outline & Border Stroke',
        'shape_stroke_width' => 'Stroke Width',
        'shape_stroke_color' => 'Stroke Color',
        'stroke_style_label' => 'Stroke Style',
        'stroke_solid' => 'Solid',
        'stroke_dashed' => 'Dashed',
        'stroke_dotted' => 'Dotted',
        'stroke_double' => 'Double',

        'text_input_label' => 'Add Word / Caption',
        'text_placeholder' => 'Type your words here...',
        'font_family' => 'Font Style',
        'font_sans' => 'Modern Sans',
        'font_montserrat' => 'Montserrat (Bold Clean)',
        'font_poppins' => 'Poppins (Rounded Modern)',
        'font_outfit' => 'Outfit (Futuristic Sans)',
        'font_inter' => 'Inter (Crisp UI)',
        'font_serif' => 'Classic Serif',
        'font_playfair' => 'Playfair Display (Luxury Serif)',
        'font_cinzel' => 'Cinzel (Roman Regal)',
        'font_impact' => 'Bold Impact',
        'font_bebas' => 'Bebas Neue (Poster Headline)',
        'font_anton' => 'Anton (Heavy Black)',
        'font_cursive' => 'Handwriting / Script',
        'font_pacifico' => 'Pacifico (Fun Brush)',
        'font_dancing' => 'Dancing Script (Romantic Flow)',
        'font_greatvibes' => 'Great Vibes (Luxury Calligraphy)',
        'font_caveat' => 'Caveat (Casual Handwritten)',
        'font_lobster' => 'Lobster (Vintage Retro)',
        'font_righteous' => 'Righteous (Cyber Neon)',
        'font_pressstart' => 'Press Start 2P (8-Bit Arcade)',
        'font_orbitron' => 'Orbitron (Sci-Fi Techno)',
        ...
        'ui_inside_mode_title' => 'Remove Inside Mode (Reverse Cutout)',
        'ui_inside_mode_desc' => 'Switch between standard background removal (keeping the subject) and inside removal (keeping the background scene and turning the subject into a transparent cutout).',
    ...
    'zh' => [
        ...
        'clear_image' => '清除图片',
        'change_image' => '更换图片',
        'cutout_mode_title' => '处理模式',
        'mode_remove_bg' => '去除背景',
        'mode_remove_bg_badge' => '保留主体',
        'mode_remove_bg_desc' => '自动识别并抠出前景主体，将背景变为透明。',
        'mode_remove_inside' => '去除内部 (反向镂空)',
        'mode_remove_inside_badge' => '保留背景',
        'mode_remove_inside_desc' => '完整保留背景环境，将主体人物或物体挖空变成透明 (反向剪裁)。',
        'btn_remove_bg' => '开始去除背景',
        'btn_remove_inside' => '开始去除主体内部',
        ...
        // Result
        'bg_removed' => '背景已成功去除',
        'inside_removed' => '主体内部已去除 (反向镂空)',
        'png_ready' => '透明 PNG 已就绪',
        'inside_png_ready' => '反向镂空 PNG 已就绪',
        'original_img' => '原图预览',
        'result_img' => '抠图结果',
        'result_mode_bg' => '去除背景 (保留主体)',
        'result_mode_inside' => '去除内部 (保留背景)',
        'upload_another' => '上传另一张',
        'download_png' => '下载 PNG 图片',
        'download_inside_png' => '下载镂空 PNG',
        'btn_edit_original' => '编辑原图 (跳过抠图)',
        'btn_edit_result' => '编辑抠图',
        'btn_invert_cutout' => '反向镂空 (内外互换)',
        'invert_cutout_hint' => '随时在保留主体与保留背景之间切换。',
        ...
        'pan_zoom' => '画面缩放',
        'zoom_out' => '缩小图片 (Zoom Out)',
        'zoom_in' => '放大图片 (Zoom In)',
        'zoom_reset' => '重置 100%',
        ...
        'free_chop_interactive_title' => '交互式自由剪裁 (画布手柄)',
        'free_chop_interactive_desc' => '在画布上直接拖拽 8 个边角手柄或框选区域，随心修剪图片边框。',
        'free_chop_reset' => '重置全部边框',
        'free_chop_square' => '正方形 (1:1)',
        'free_chop_fit' => '全图适应',
        'free_chop_hint' => '💡 提示：在画布上拖拽边角手柄即可剪裁边框，拖拽方框中心可平移剪裁窗口。',
        'crop_top' => '裁切上方',
        'crop_bottom' => '裁切下方',
        'crop_left' => '裁切左侧',
        'crop_right' => '裁切右侧',
        ...
        'filter_cool' => '冷色调',
        'filter_contrast' => '高对比',
        'filter_cyberpunk' => '赛博朋克霓虹',
        'filter_noir' => '黑白电影质感',
        'filter_golden' => '落日暖阳 (黄金时段)',
        'filter_cinema' => '青橙色调 (院线质感)',
        'filter_pastel' => '梦幻柔和粉彩',
        'filter_retro' => '90年代胶片复古',
        'filter_emerald' => '森系翠绿',
        'filter_lilac' => '丁香淡紫光芒',
        'filter_invert' => '反相底片 (负片)',
        'filter_popart' => '波普艺术双色',
        'filter_nordic' => '冷峻北欧霜冷',
        'filter_vignette' => '暗角预设',
        'hue_rotate' => '色彩色相旋转',
        'vignette' => '暗角明暗程度',
        'vignette_color' => '暗角与边缘颜色',
        'vignette_panel_desc' => '在图片四周边缘和四角添加柔和深色或彩色暗角阴影，凸显画面中心主体。',
        'edge_blur_title' => '边缘虚化与柔化 (景深大光圈)',
        'edge_blur_amount' => '虚化强度',
        'edge_blur_style' => '虚化模式',
        'edge_blur_radial' => '大光圈四周景深虚化',
        'edge_blur_feather' => '柔和边缘羽化渐隐',
        'edge_blur_hint' => '强力虚化外边缘，模拟相机大光圈景深或柔和羽化边缘。',
        'preset_none' => '关闭 (0%)',
        'preset_subtle' => '轻微 (20%)',
        'preset_medium' => '适中 (45%)',
        'preset_strong' => '强烈 (80%)',
        ...
        // 图片透明度
        'pic_opacity_title' => '图片透明度 / 不透明度',
        'pic_opacity_solid' => '100% 不透明',
        'pic_opacity_75' => '75%',
        'pic_opacity_semi' => '50% 半透明',
        'pic_opacity_faint' => '25% 淡化',

        // 投影与立体阴影
        'shadow_title' => '投影与立体阴影 (3D 阴影)',
        'shadow_preset_soft' => '柔和投影',
        'shadow_preset_3d' => '立体深邃',
        'shadow_preset_float' => '悬浮漂浮',
        'shadow_preset_halo' => '霓虹光晕',
        'shadow_preset_ground' => '地面接地',
        'shadow_color' => '阴影颜色',
        'shadow_blur' => '阴影柔化度 (模糊)',
        'shadow_offset_x' => '水平距离 (X)',
        'shadow_offset_y' => '垂直距离 (Y)',
        'shadow_opacity' => '阴影透明度 / 浓度',

        // 自由剪裁与描边风格
        'shape_freecut' => '自由套索剪裁 (Free Cut)',
        'freecut_toolbar_title' => '交互式自由剪裁工具',
        'freecut_mode_lasso' => '自由手绘套索',
        'freecut_mode_polygon' => '多边形描点',
        'freecut_points_count' => '控制点',
        'freecut_finish' => '完成剪裁',
        'freecut_undo' => '撤销点',
        'freecut_reset' => '清除路径',
        'freecut_hint_lasso' => '💡 提示：在图片上按住鼠标或手指自由手绘一圈，即可完成任意形状剪裁！',
        'freecut_hint_polygon' => '💡 提示：顺着主体轮廓依次点击打点，完成后点击【完成剪裁】！',
        'shape_stroke_title' => '贴纸轮廓线与边缘描边',
        'shape_stroke_width' => '描边粗细',
        'shape_stroke_color' => '描边颜色',
        'stroke_style_label' => '描边虚实线条风格',
        'stroke_solid' => '实线 (Solid)',
        'stroke_dashed' => '虚线 (Dashed)',
        'stroke_dotted' => '圆点点线 (Dotted)',
        'stroke_double' => '双层霓虹 (Double)',

        'text_input_label' => '添加文字 / 标语',
        'text_placeholder' => '在此输入要添加的文字...',
        'font_family' => '字体风格',
        'font_sans' => '现代无衬线 (Sans)',
        'font_montserrat' => 'Montserrat (现代粗体)',
        'font_poppins' => 'Poppins (圆润简约)',
        'font_outfit' => 'Outfit (未来极简)',
        'font_inter' => 'Inter (超清界面体)',
        'font_serif' => '优雅衬线 (Serif)',
        'font_playfair' => 'Playfair Display (高雅衬线)',
        'font_cinzel' => 'Cinzel (罗马宫廷体)',
        'font_impact' => '醒目粗体 (Impact)',
        'font_bebas' => 'Bebas Neue (海报大字)',
        'font_anton' => 'Anton (超重厚黑)',
        'font_cursive' => '手写艺术体 (Script)',
        'font_pacifico' => 'Pacifico (复古笔刷)',
        'font_dancing' => 'Dancing Script (浪漫连笔)',
        'font_greatvibes' => 'Great Vibes (华丽花体)',
        'font_caveat' => 'Caveat (随性手写)',
        'font_lobster' => 'Lobster (经典复古POP)',
        'font_righteous' => 'Righteous (赛博霓虹)',
        'font_pressstart' => 'Press Start 2P (8位复古像素)',
        'font_orbitron' => 'Orbitron (科幻机甲)',
        ...
        'ui_inside_mode_title' => '去除主体内部模式 (反向镂空)',
        'ui_inside_mode_desc' => '随时在常规背景去除 (保留主体) 与主体内部去除 (保留背景、主体镂空透明) 之间即时无缝切换。',
    ...
    'ms' => [
        ...
        'cutout_mode_title' => 'Mod Pemprosesan',
        'mode_remove_bg' => 'Buang Latar Belakang',
        'mode_remove_bg_badge' => 'Kekalkan Subjek',
        'mode_remove_bg_desc' => 'Mengasingkan subjek di hadapan dan menjadikan latar belakang lutsinar.',
        'mode_remove_inside' => 'Buang Bahagian Dalam (Balikan)',
        'mode_remove_inside_badge' => 'Kekalkan Latar Belakang',
        'mode_remove_inside_desc' => 'Mengekalkan latar belakang dan membuang subjek bahagian dalam menjadi lutsinar (potongan balikan).',
        'btn_remove_bg' => 'Buang Latar Belakang',
        'btn_remove_inside' => 'Buang Bahagian Dalam (Balikan)',
        ...
        'inside_removed' => 'Bahagian Dalam Dibuang (Potongan Balikan)',
        'png_ready' => 'PNG Lutsinar Sedia',
        'inside_png_ready' => 'PNG Potongan Berongga Sedia',
        'original_img' => 'Imej Asal',
        'result_img' => 'Hasil Potongan',
        'result_mode_bg' => 'Buang Latar (Kekal Subjek)',
        'result_mode_inside' => 'Buang Dalam (Kekal Latar)',
        'upload_another' => 'Muat Naik Lain',
        'download_png' => 'Muat Turun PNG',
        'download_inside_png' => 'Muat Turun PNG Berongga',
        'btn_edit_original' => 'Sunting Foto (Langkau AI)',
        'btn_edit_result' => 'Sunting Hasil',
        'btn_invert_cutout' => 'Balikkan Potongan (Dalam ⇄ Luar)',
        'invert_cutout_hint' => 'Tukar antara mengekalkan subjek atau mengekalkan latar belakang.',
        ...
        'pan_zoom' => 'Zum Foto',
        'zoom_out' => 'Zum Keluar (Kecilkan)',
        'zoom_in' => 'Zum Masuk (Besarkan)',
        'zoom_reset' => 'Tetap Semula 100%',
        ...
        'free_chop_interactive_title' => 'Potong Bebas Interaktif',
        'free_chop_interactive_desc' => 'Seret 8 pemegang pada kanvas atau seret kotak terus untuk memotong sempadan foto secara bebas.',
        'free_chop_reset' => 'Tetapkan Semula Sempadan',
        'free_chop_square' => 'Segi Empat (1:1)',
        'free_chop_fit' => 'Muat Penuh',
        'free_chop_hint' => '💡 Tip: Seret pemegang bucu atau tepi pada kanvas untuk memotong. Seret tengah kotak untuk mengubah kedudukan.',
        ...
        'filter_cyberpunk' => 'Cyberpunk Neon',
        'filter_noir' => 'Filem Noir',
        'filter_golden' => 'Waktu Emas (Sunset)',
        'filter_cinema' => 'Teal & Jingga (Pawagam)',
        'filter_pastel' => 'Impian Pastel',
        'filter_retro' => 'Filem Retro 90-an',
        'filter_emerald' => 'Hutan Zamrud',
        'filter_lilac' => 'Cahaya Ungu Lilac',
        'filter_invert' => 'Negatif / Songsang',
        'filter_popart' => 'Seni Pop Dwi-warna',
        'filter_nordic' => 'Fros Nordik Dingin',
        'filter_vignette' => 'Pratetap Vignet',
        'hue_rotate' => 'Putaran Warna Hue',
        'vignette' => 'Keamatan Vignet Gelap Tepi',
        'vignette_color' => 'Warna Vignet & Tepi',
        ...
        // Ketelusan Gambar
        'pic_opacity_title' => 'Ketelusan / Kelegapan Gambar',
        'pic_opacity_solid' => '100% Padu',
        'pic_opacity_75' => '75%',
        'pic_opacity_semi' => '50% Separuh',
        'pic_opacity_faint' => '25% Pudar',

        // Bayang Jatuh & Kedalaman 3D
        'shadow_title' => 'Bayang Jatuh & Kedalaman 3D',
        'shadow_preset_soft' => 'Bayang Lembut',
        'shadow_preset_3d' => 'Kedalaman 3D',
        'shadow_preset_float' => 'Terapung',
        'shadow_preset_halo' => 'Halo Neon',
        'shadow_preset_ground' => 'Sentuh Lantai',
        'shadow_color' => 'Warna Bayang',
        'shadow_blur' => 'Kelembutan Bayang (Kabur)',
        'shadow_offset_x' => 'Jarak Mendatar (X)',
        'shadow_offset_y' => 'Jarak Menegak (Y)',
        'shadow_opacity' => 'Kelegapan Bayang',

        // Potong Bebas & Gaya Garis Luar
        'shape_freecut' => 'Potong Bebas (Lasso)',
        'freecut_toolbar_title' => 'Alatan Potong Bebas Interaktif',
        'freecut_mode_lasso' => 'Lasso Bebas Tangan',
        'freecut_mode_polygon' => 'Titik Poligon',
        'freecut_points_count' => 'Titik',
        'freecut_finish' => 'Selesai Potong',
        'freecut_undo' => 'Undur Titik',
        'freecut_reset' => 'Padam Laluan',
        'freecut_hint_lasso' => '💡 Tip: Tekan dan seret pada foto untuk melukis gelung potongan bebas!',
        'freecut_hint_polygon' => '💡 Tip: Klik titik sekeliling subjek, kemudian klik Selesai Potong!',
        'shape_stroke_title' => 'Garis Pelekat & Garis Tepi Bentuk',
        'shape_stroke_width' => 'Ketebalan Garis',
        'shape_stroke_color' => 'Warna Garis',
        'stroke_style_label' => 'Gaya Garisan',
        'stroke_solid' => 'Padu (Solid)',
        'stroke_dashed' => 'Garis Putus (Dashed)',
        'stroke_dotted' => 'Titik (Dotted)',
        'stroke_double' => 'Berganda (Double)',
        ...
        'font_montserrat' => 'Montserrat (Tebal Kemas)',
        'font_poppins' => 'Poppins (Moden Bulat)',
        'font_outfit' => 'Outfit (Futuristik Sans)',
        'font_inter' => 'Inter (Antara Muka Jelas)',
        'font_serif' => 'Klasik Berserip (Serif)',
        'font_playfair' => 'Playfair Display (Serif Mewah)',
        'font_cinzel' => 'Cinzel (Klasik Rom)',
        'font_impact' => 'Tebal Menyerlah (Impact)',
        'font_bebas' => 'Bebas Neue (Tajuk Poster)',
        'font_anton' => 'Anton (Hitam Tebal)',
        'font_cursive' => 'Tulisan Tangan / Kursif (Script)',
        'font_pacifico' => 'Pacifico (Berus Seronok)',
        'font_dancing' => 'Dancing Script (Aliran Romantik)',
        'font_greatvibes' => 'Great Vibes (Kaligrafi Mewah)',
        'font_caveat' => 'Caveat (Tulisan Tangan Santai)',
        'font_lobster' => 'Lobster (Retro Klasik)',
        'font_righteous' => 'Righteous (Neon Siber)',
        'font_pressstart' => 'Press Start 2P (Piksel 8-Bit)',
        'font_orbitron' => 'Orbitron (Tekno Sains Fiksyen)',
        ...
        'ui_inside_mode_title' => 'Mod Buang Bahagian Dalam (Balikan)',
        'ui_inside_mode_desc' => 'Tukar antara pembuangan latar belakang biasa (kekalkan subjek) dan pembuangan dalam (kekalkan latar belakang dan jadikan subjek lutsinar).',
